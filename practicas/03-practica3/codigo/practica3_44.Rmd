...
\begin{itemize}
    \item Discutir cómo debería verse el histograma de n números para $a$ y $m$ dados. Con n grande.
    
    \item Hacer el histograma de 500 000 números con el comando \textit{hist()} y el argumento \textit{probability = TRUE}.
    \item Con tres valores distintos de a y tres valores distintos de m generar 1000 valores para cada par de parámetros y hacer una gráfica de 1000 puntos en 
...
¿Cual generador de números es mejor? \textit{runif} o el que  programaron aquí.\ \
